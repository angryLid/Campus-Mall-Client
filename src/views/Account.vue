  ...
  <div class="wrapper">
    <div class="avatar">
      ...
      <div class="info">
        ...
        <div><span class="tag sd">姓名</span>{{ this.person.uname }}</div>
        <div><span class="tag sd">性别</span>{{ this.person.usex }}</div>
        <div><span class="tag td">部门</span>{{ this.person.department }}</div>
        <div><span class="tag td">职位</span> {{ this.person.position }}</div>
        <div>
